...
export const HeroOne = () => {
  const title = "MIT Polytechnic College & MIT ITI College - The Best Place to Invest in your Knowledge";
  const subtitle = "MIT Polytechnic & ITI College comprises MIT Polytechnic College and MIT ITI College, situated in the heart of nature at Cauvery Cross, Mettur Dam. Our green and eco-friendly campus offers a comfortable and conducive learning environment. With easy access via the main road and bus facility, we're committed to providing quality technical education and a better future for our students.";
  const videoUrl = "https://www.youtube.com/embed/LBp8FwDfBz8?autoplay=1&mute=1&loop=1&controls=0&showinfo=0&rel=0&modestbranding=1&playlist=LBp8FwDfBz8&playsinline=1&enablejsapi=1";
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          width: '100%',
          height: '100%',
          backgroundColor: 'rgba(0, 0, 27, 0.6)',
          zIndex: 1,
          pointerEvents: 'none'
        }} />
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            <p className="td_hero_subtitle_up td_white_color td_spacing_1 td_semibold text-uppercase td_mb_10 td_opacity_9" style={{ fontSize: 'clamp(0.875rem, 1.2vw, 1.125rem)' }}>
              Knowledge is Power
            </p>
            <h1 className="td_hero_title td_white_color td_mb_12" style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', lineHeight: '1.2' }}>
              {title}
            </h1>
            <p className="td_hero_subtitle td_white_color td_opacity_7 td_mb_30" style={{ fontSize: 'clamp(0.875rem, 1.1vw, 1.125rem)', lineHeight: '1.6' }}>
              {subtitle}
            </p>
            <Link
